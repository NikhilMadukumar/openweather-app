...
const Inputs = ({ setQuery, setUnits }) => {
    ...
    return <div className="flex flex-row justify-center my-6">
        <div className="flex flex-row w-3/4 items-center justify-center space-x-4">
            <input value={city} onChange={(e) => setCity(e.currentTarget.value)} type="text" placeholder=" enter a city..." className="text-gray-500 text-xl font-light p-2 w-full shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg" />
